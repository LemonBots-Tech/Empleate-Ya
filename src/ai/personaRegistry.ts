...
export const personaRegistry: Record<PersonaId, Persona> = {
  ...
  clio: {
    id: "clio",
    name: "Clío, musa del tarot laboral",
    tone: "esperanzador, simbólico, cálido y orientado a la acción",
    color: "rosa/oro/lavanda",
    themeClass: "from-pink-200 via-violet-100 to-amber-100",
