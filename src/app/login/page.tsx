  ...
  return (
    <main className="min-h-screen bg-slate-950 px-5 py-16 text-white">
      <form action={submit} className="mx-auto max-w-md rounded-[2rem] border border-white/10 bg-white/5 p-8">
        ...
        <div className="mt-6 flex gap-3"><Button className="bg-blue-600">Entrar</Button><Link className="rounded-2xl border border-white/20 px-4 py-2.5 font-bold" href="/register">Crear cuenta</Link></div>
