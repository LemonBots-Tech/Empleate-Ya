...
const copy = {
  es: {
    ...
    userSubsections: [
      ...
      ["Alumnos", "/admin/users/students"],
      ["Empresa outplacement", "/admin/users/outplacement-rh"],
      ["Ex-empleados outplacement", "/admin/users/outplacement-employees"],
    ],
  },
  en: {
    title: "Super Admin",
    ...
    userSubsections: [
      ...
      ["Outplacement former employees", "/admin/users/outplacement-employees"],
    ],
  },
} as const;
